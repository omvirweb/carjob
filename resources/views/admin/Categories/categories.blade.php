        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post" id="addnewcategory_add_form">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-12">
                                <fieldset>
                            ...
                            <div class="col-md-12">
                                <fieldset>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input name="categorystatus" type="radio" id="radio_31" class="with-gap radio-col-pink" value="0" checked />
                                            <label for="radio_31">Active</label>
                                            <input name="categorystatus" type="radio" id="radio_30" class="with-gap radio-col-red" value="1" />
                            ...
                            <div class="col-md-12">
                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-md-9 control-label">Category Name: </label>
                                        <div class="col-md-12">
                                            <input type="text" class="form-control"  name="ecategory_name" id="ecategory_name" placeholder="Enter category name" required>
                            ...
                            <div class="col-md-12">
                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-md-9 control-label">Status: </label>
                                        <div class="col-md-10">
                                            <input name="ecategorystatus" type="radio" id="radio_1" class="with-gap radio-col-pink" value="0" checked />
                                            <label for="radio_1">Active</label>
                                            <input name="ecategorystatus" type="radio" id="radio_2" class="with-gap radio-col-red" value="1" />
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{url('admin/categoryDelete')}}" method="post" id="dform">
                        @csrf
            ...
            <div class="card">
                <div class="card-body">
                     ...
                     <div class="row">
                        ...
                        <div class="col-9">
                            <form action="{{ url('/admin/categoryList')}}">
                                <div class="form-row">
                    ...
                    <div class="table-responsive">
                        <table class="table color-table success-table">
                            ...
                            <tbody>
                                @if(!empty($Categories->toArray()['data']))
                                    @foreach($Categories as $key => $value)
                                        <tr>
                                            <td>{{ $value->categoryName }}</td>
                                            <td>
                                                <img class="card-img-top" src="@if($value->image != '') {{ url('/').'/uploads/category/'.$value->image }} @else {{ 'http://placehold.it/200x200' }}  @endif " alt="Card image" style="width: 100px;">
                                            </td>
...
<script>
    var path = "{{asset('uploads/category/')}}";
    $.ajaxSetup({
        headers: {
    ...
    $("#addnewcategory_add_form").validate({
        rules: {
            category_name: {
                required: true
            }
        ...
        submitHandler: function(form) {
            ...
            var categorystatus= $("input:radio[name=categorystatus]:checked").val();
            
            var form_data = new FormData();
                form_data.append('category_name', category_name);
                form_data.append('categorystatus', categorystatus);
    ...
    $('.edit_categories').click(function(){
        ...
        $.ajax({
            ...
            success : function (data) {
                ...
                $('#eid').val(data.id);
                $('#ecategory_name').val(data.categoryName);
    ...
    $("#editnewcategories_form").validate({
        ...
        submitHandler: function(form) {
            ...
            var category_name=$('#ecategory_name').val();
            var doc_file1=$('#edoc_file1').prop('files')[0];
            var fileuploadval=$('#fileuploadval').val();
            var categorystatus= $("input:radio[name=ecategorystatus]:checked").val();
